(async () => {
  ...
  compSet.name = "Foundation Button (Clean Active)";
  ...
  console.log("🚀 [v4.3] Active 상태 재활용 매핑 완벽 적용 성공!");
})();