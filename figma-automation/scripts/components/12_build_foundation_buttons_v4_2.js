(async () => {
  ...
  const tokenConfig = {
    ...
    Danger: {
      ...
      Hover:    { Bg: "accent",               Text: "text-inverse" }, // Danger hover 전용이 없다면 accent 재활용
  ...
  compSet.name = "Foundation Button (Ultimate)";
  ...
  console.log("🚀 [v4.2] 유저님의 진짜 토큰 19개가 완벽히 이식된 최종 버튼 생성 완료!");
})();